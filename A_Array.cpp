...
public:
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ...
        //neg => odd number of negative elements
        //0 => all zeroes here
        //+ve => even number of negatives
        ...
        if(n.size()%2!=0){    
            ...
            cout<<1<<" "<<n[0];nl;
           //+ve
            cout<<(n.size()-1)+p.size()<<" ";
            if(n.size()!=1)ff(i,1,n.size())cout<<n[i]<<" ";
            
            for(auto iter:p)cout<<iter<<" ";
            nl;
            //0
             cout<<z.size()<<" ";
            for(auto iter:z)cout<<iter<<" ";
            nl;
        }else{
            //-ve
            cout<<1<<" "<<n[0];nl;
            //+ve
            cout<<p.size()<<" ";for(auto iter:p)cout<<iter<<" ";nl;
            //0
            cout<<z.size()+n.size()-1<<" ";
            for(auto iter:z)cout<<iter<<" ";
            ff(i,1,n.size())cout<<n[i];
        } 
    }
};
