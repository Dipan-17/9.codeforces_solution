...
public:
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ll n;cin>>n;
        vl v(2*n);readvector(v);sv(v);
        
        //The main idea is that we can split the numbers into the two halves, 
        //the big half and small half, 
        //we can place the bigger half at the odd positions 
        //and the smaller half at the even positions.
        //This works because the smallest big number is larger than 
        //the biggest small number. 
        //Hence, the mean of any two small numbers is smaller 
        //than any big number, and the mean of any two big numbers is bigger
        // than any small number.
