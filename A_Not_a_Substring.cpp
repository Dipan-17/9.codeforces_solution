...
public:
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ...
        //only 2 possibilities of regular: ()() or (()) of size 2n
        // construct both and check
        string pos1="",pos2="";
        ff(i,0,n)pos1+="()";
        ff(i,0,n)pos2+="(";
        ff(i,0,n)pos2+=")";
        
        (pos1.find(s)==string::npos)?(cout<<"YES"<<endl<<pos1):
            ((pos2.find(s)==string::npos)?(cout<<"YES"<<endl<<pos2):cout<<"NO");    
    }
};
