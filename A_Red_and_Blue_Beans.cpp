...
public:
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ...
        //we can make a max of mini packets
        //in that condition each packet can hold at max: d+1 other beans
        //cause already one of type mini -> maxi is d+1
        //total number of maxi that can be accumulated: (d+1)*mini
