...
public:
    ...
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ...
        //first monster will not die until each of the monsters health are <= k
        //cause the larger one is previously targeted
        //so all health first become less than equal to k
        //then they start dying one by one

        //where the health is a multiple of k, they die first, cause they reach zero first
