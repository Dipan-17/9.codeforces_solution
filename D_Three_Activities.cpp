...
public:
    void solve() {
       ...
       //freopen("output.txt", "w", stdout);
        ...
        int n;cin>>n;
        vector<ppi>a,b,c;
        ff(i,0,n){int x;cin>>x; a.pb(make_pair(x,i+1));}
        ff(i,0,n){int x;cin>>x; b.pb(make_pair(x,i+1));}
        ff(i,0,n){int x;cin>>x; c.pb(make_pair(x,i+1));}

        sort(a.begin(),a.end(),greater<ppi>());
        sort(b.begin(),b.end(),greater<ppi>());
        sort(c.begin(),c.end(),greater<ppi>());
